                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <?php if (!empty($foto['caption'])): ?>
                                <small
                                    class="text-muted d-block mt-2"><?php echo htmlspecialchars($foto['caption']); ?></small>
                                <?php endif; ?>
                            </div>
                            <?php endforeach; ?>
                        </div>
        ...
        <div class="row mb-4">
            <div class="col">
                <div class="btn-group" role="group">
                    ...
                    <a href="news.php?kategori=berita"
                        class="btn btn-<?php echo $kategori_filter == 'berita' ? 'primary' : 'outline-primary'; ?>">
                        Berita
                    </a>
                    <a href="news.php?kategori=agenda"
                        class="btn btn-<?php echo $kategori_filter == 'agenda' ? 'primary' : 'outline-primary'; ?>">
                        Agenda
                    </a>
                    <a href="news.php?kategori=pengumuman"
                        class="btn btn-<?php echo $kategori_filter == 'pengumuman' ? 'primary' : 'outline-primary'; ?>">
                        Pengumuman
                    </a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 overflow-hidden">
                    <?php if ($thumbnail):
                                ...
                                ?>
                    <img src="<?php echo $thumb_path; ?>" class="card-img-top" style="height: 200px; object-fit: cover;"
        ...
        <nav aria-label="Page navigation" class="mt-5">
            <ul class="pagination justify-content-center">
                <li class="page-item <?= ($page <= 1) ? 'disabled' : '' ?>">
                    <a class="page-link"
                        href="?<?= $kategori_filter ? 'kategori=' . $kategori_filter . '&' : '' ?>page=<?= $page - 1 ?>">&laquo;
                        Sebelumnya</a>
                </li>
                ...
                <li class="page-item">
                    <a class="page-link"
                        href="?<?= $kategori_filter ? 'kategori=' . $kategori_filter . '&' : '' ?>page=1">1</a>
                </li>
                <?php if ($start_page > 2): ?>
                ...
                <li class="page-item <?= ($page == $i) ? 'active' : '' ?>">
                    <a class="page-link"
                        href="?<?= $kategori_filter ? 'kategori=' . $kategori_filter . '&' : '' ?>page=<?= $i ?>"><?= $i ?></a>
                </li>
                <?php endfor; ?>
                ...
                <li class="page-item">
                    <a class="page-link"
                        href="?<?= $kategori_filter ? 'kategori=' . $kategori_filter . '&' : '' ?>page=<?= $total_pages ?>"><?= $total_pages ?></a>
                </li>
                <?php endif; ?>

                <li class="page-item <?= ($page >= $total_pages) ? 'disabled' : '' ?>">
                    <a class="page-link"
                        href="?<?= $kategori_filter ? 'kategori=' . $kategori_filter . '&' : '' ?>page=<?= $page + 1 ?>">Selanjutnya
                        &raquo;</a>
                </li>
            </ul>
        </nav>
